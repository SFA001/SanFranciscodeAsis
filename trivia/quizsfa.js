// Base de datos de preguntas por categoría y dificultad
        const questionsDatabase = {
            religion: {
                easy: [
                    {
                        question: "¿Cuál es el libro sagrado del cristianismo?",
                        options: ["La Biblia", "El Corán", "La Torá", "El Bhagavad Gita"],
                        correct: 0
                    },
                    {
                        question: "¿En qué religión se practica el Ramadan?",
                        options: ["Islam", "Cristianismo", "Hinduismo", "Budismo"],
                        correct: 0
                    },
                    {
                        question: "¿Quién construyó el Arca según la Biblia?",
                        options: ["Noé", "Moisés", "Abraham", "David"],
                        correct: 0
                    },
                    {
                        question: "¿Cuál es la ciudad sagrada para el Islam?",
                        options: ["La Meca", "Jerusalén", "Roma", "Varanasi"],
                        correct: 0
                    },
                    {
                        question: "¿Quién es el fundador del Budismo?",
                        options: ["Buda", "Confucio", "Lao-Tsé", "Mahavira"],
                        correct: 0
                    }
                ],
                medium: [
                    ...
                    {
                        question: "¿Qué religión sigue las enseñanzas de Buda?",
                        options: ["Budismo", "Hinduismo", "Jainismo", "Sintoísmo"],
                        correct: 0
                    },
                    {
                        question: "¿En qué libro sagrado se encuentra la historia de Moisés?",
                        options: ["La Biblia", "El Corán", "Los Vedas", "El Libro de los Muertos"],
                        correct: 0
                    },
                    {
                        question: "¿Qué religión practica la mayoría de la población india?",
                        options: ["Hinduismo", "Islam", "Cristianismo", "Budismo"],
                        correct: 0
                    },
                    {
                ...
                hard: [
                    {
                        question: "¿En qué año se produjo el Cisma de Oriente?",
                        options: ["1054", "1520", "787", "1215"],
                        correct: 0
                    },
                    {
                        question: "¿Qué concilio ecuménico se realizó entre 1962 y 1965?",
                        options: ["Concilio Vaticano II", "Concilio de Trento", "Concilio de Nicea", "Concilio de Constantinopla"],
                        correct: 0
                    },
                    {
                        question: "¿Quién fue el reformador protestante francés?",
                        options: ["Juan Calvino", "Martin Lutero", "Ulrico Zuinglio", "John Wesley"],
                        correct: 0
                    },
                    {
                        question: "¿En qué año se decretó el Edicto de Milán que legalizó el cristianismo?",
                        options: ["313", "380", "451", "325"],
                        correct: 0
                    },
                    {
                        question: "¿Qué papa convocó la Primera Cruzada?",
                        options: ["Urbano II", "Gregorio VII", "Inocencio III", "León X"],
                        correct: 0
                    }
                ]
            },
